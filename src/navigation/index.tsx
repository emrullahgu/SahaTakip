...
function MainStack() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="ChangePassword" component={require('../screens/ChangePasswordScreen').default} options={{ headerShown: true, title: 'Şifre Değiştir', headerStyle: { backgroundColor: colors.bg.secondary }, headerTintColor: colors.text.primary, headerTitleStyle: { fontWeight: '700' } }} />
