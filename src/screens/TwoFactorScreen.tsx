...
const styles = StyleSheet.create({
  ...
  qrHintText: { color: colors.text.faint, fontSize: 9, paddingHorizontal: 8, textAlign: 'center' },
  uriText: { marginTop: spacing.sm, color: colors.text.muted, fontSize: 9, textAlign: 'center' },
